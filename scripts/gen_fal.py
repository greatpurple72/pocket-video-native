...
SCENES = [
 ...
 ("pv-title", "landscape_16_9", "cinematic key art, a packed football stadium at night under bright floodlights, fireworks and dramatic light beams, lens flares, empty center foreground space for a game logo, epic next-gen football game title shot, photoreal, no UI, 4k"),
 ("pv-celebration", "landscape_16_9", "in-game football gameplay EA Sports FC / eFootball style, photoreal, a star striker with a subtly enlarged head (~6 heads, realistic body) celebrating a goal, arms wide, sliding on his knees, teammates running to join, roaring packed crowd, floodlit night stadium, broadcast camera, clean no UI, 4k"),
 ("pv-penalty", "portrait_16_9", "in-game football gameplay EA FC style, photoreal, penalty kick moment, a striker (subtly enlarged head ~6 heads, realistic body) striking the ball toward goal, goalkeeper diving to save, tense floodlit stadium, broadcast camera behind taker, clean no UI, 4k"),
 ("pv-skill", "landscape_16_9", "in-game football gameplay EA FC style, photoreal, dynamic dribble skill move, a player (subtly enlarged head ~6 heads, realistic body) performing a step-over past a defender, low dramatic angle, motion blur, floodlit stadium, broadcast camera, clean no UI, 4k"),
 ("pv-squad", "landscape_16_9", "top-down football tactics lineup screen, a green pitch viewed from above with 11 player position slots arranged in a 4-3-3 formation shown as glowing markers and small player portrait cards, sleek dark game UI panels on the sides, squad management screen, premium mobile football game, 4k"),
]
