...
def stadium_marker(x,y,col):
    d.ellipse([x-10,y-10,x+10,y+10],fill=col,outline=(255,255,255,230),width=2)
    d.ellipse([x-4,y-4,x+4,y+4],fill=(255,255,255,230))
# 大陆上的其他玩家俱乐部基地(体现多人在线)
players=[("绿茵王朝","FCB",(80,200,120,255),0.16,0.30),
         ("曼城之巅","SKY",(120,180,255,255),0.50,0.22),
         ("烈焰之心","RED",(255,90,90,255),0.60,0.40),
         ("沙漠雄鹰","DSR",(245,205,70,255),0.55,0.60),
         ("黄潜军团","YEL",(245,180,60,255),0.26,0.66),
         ("东方巨龙","DRG",(255,120,90,255),0.82,0.34),
         ("狮城卫士","LON",(150,120,255,255),0.78,0.58),
         ("南十字星","ANZ",(90,200,160,255),0.87,0.74)]
for name,ally,col,fx,fy in players:
    x,y=int(W*fx),int(H*fy)
    stadium_marker(x,y,col)
    tag(x+14,y-12,name,ally,col)
# 中央:世界冠军球场(终极争夺目标)
gx,gy=int(W*0.5),int(H*0.40)
for r,a in [(34,40),(24,70),(15,150)]:
    d.ellipse([gx-r,gy-r,gx+r,gy+r],fill=(255,210,90,a))
d.polygon([(gx,gy-12),(gx+4,gy-3),(gx+13,gy-3),(gx+6,gy+3),(gx+9,gy+12),(gx,gy+6),
           (gx-9,gy+12),(gx-6,gy+3),(gx-13,gy-3),(gx-4,gy-3)],fill=(255,225,150,255))
panel(gx-66,gy+16,gx+66,gy+40,(40,18,18,210),r=10)
text(gx,gy+28,"世界冠军球场",14,(255,225,180,255),anchor="mm")
...
march(int(W*0.18),int(H*0.32),int(W*0.48),int(H*0.40),(255,210,90,255),"02:42")
march(int(W*0.82),int(H*0.36),int(W*0.52),int(H*0.40),(255,90,90,255),"03:10")
march(int(W*0.28),int(H*0.64),int(W*0.50),int(H*0.42),(120,180,255,255),"04:05")
